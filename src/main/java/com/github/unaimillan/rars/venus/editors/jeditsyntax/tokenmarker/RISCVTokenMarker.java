...
import com.github.unaimillan.rars.assembler.Directives;
...
import com.github.unaimillan.rars.venus.editors.jeditsyntax.KeywordMap;
import com.github.unaimillan.rars.venus.editors.jeditsyntax.PopupHelpItem;
...
public class RISCVTokenMarker extends TokenMarker {
    ...
    private static KeywordMap getKeywords() {
        if (cKeywords == null) {
            ...
            for (Instruction inst : Globals.instructionSet.getInstructionList()) {
